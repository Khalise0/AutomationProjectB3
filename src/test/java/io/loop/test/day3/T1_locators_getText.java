...
public class T1_locators_getText {
    public static void main(String[] args) {
        ...
        //ctrl F to see window to check how many there matches
        ...
        if (actualErrorMessage.equals(DocuportConstants.ERROR_MESSAGE_FOR_EMPTY_PASSWORD)) {
            ...
            System.err.println("Expected error message: " + DocuportConstants.ERROR_MESSAGE_FOR_EMPTY_PASSWORD + ", not matches actual error message: " + actualErrorMessage + ". => TEST FAIL");
        }
        driver.quit();
    }
}
