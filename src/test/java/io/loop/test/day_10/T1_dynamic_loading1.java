...
public class T1_dynamic_loading1 {
    ...
    @Test public void dynamic_loading1(){
        BrowserUtilities.loopLinkClick("Dynamic Loading");
        BrowserUtilities.waitForClickable(loopPracticeDynamicLoading1.dynamicLoading1, 10).click();
        BrowserUtilities.waitForClickable(loopPracticeDynamicLoading1.startButton, 10).click();
        ...
        BrowserUtilities.waitForVisibility(loopPracticeDynamicLoading1.errorMessages, 10).isDisplayed();
    }
