...
public class T2_iframe extends TestBase {
    ...
    public void iframeTest() {
       ...
       // driver.switchTo().frame(iframe);  //with xpath

       // driver.switchTo().frame(0); //with index

        driver.switchTo().frame("mce_0_ifr"); // with id of iframe

        WebElement textBox = driver.findElement(By.xpath("//*[@id='tinymce']"));
        textBox.clear();
        textBox.sendKeys("Loop Academy");
        assertEquals(textBox.getText(), "Loop Academy","Actual does NOT match the expected" );
...
//        System.out.println("textBox = " + textBox);
    ...
    public void nestedFrame(){
        ...
        System.out.println("frames.size() = " + iframes.size());
    }
